...
<link rel="stylesheet" href="<?php echo site_url('css/estilo.css'); ?>" type="text/css" />
<link rel="stylesheet" href="<?php echo site_url('css/blitzer/jquery-ui-1.8.16.custom.css'); ?>" type="text/css" />
